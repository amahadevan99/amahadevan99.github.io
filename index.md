...
The self avoiding walk is perhaps the simplest nontrivial model of a polymer in a solvent, but its mathematical properties are still not fully understood. Here we discuss a mapping between the self avoiding walk and a model of a magnetic composed of n-component interacting spins in the limit as n goes to 0. This mapping allows to estimate scaling exponents of the self avoiding walk that can be measured experimentally as well.
